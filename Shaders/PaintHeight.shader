    ...
    SubShader {
        ...
        CGINCLUDE
            ...
            float4 PackHeightmap2(float height)
            {
        ...
        Pass    // 0 raise/lower heights
        {
            ...
            float4 RaiseHeight(v2f i) : SV_Target
            {
                ...
                return PackHeightmap2(clamp(height + BRUSH_STRENGTH * brushShape, 0, kMaxHeight));
		...
		Pass    // 1 stamp heights
        {
            ...
            float4 StampHeight(v2f i) : SV_Target
            {
                ...
                return PackHeightmap2(clamp(outheight, 0.0f, kMaxHeight));
            }
            ENDCG
        }
